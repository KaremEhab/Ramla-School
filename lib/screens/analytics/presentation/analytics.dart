      ...
      child: Row(
        ...
        children: [
          ...
          CircularPercentIndicator(
            ...
            backgroundColor: progressColor.withAlpha((0.2 * 255).round()),
      ...
      child: Column(
        children: [
          ...
          Wrap(
            ...
            spacing: 16.0,
            children: [
              _buildLegendItem(chartGreen, 'طلاب متصلين'),
              _buildLegendItem(chartRed, 'طلاب غير متصلين'),
              _buildLegendItem(chartOrange, 'معلمين متصلين'),
              _buildLegendItem(chartBlue, 'معلمين غير متصلين'),
            ],
          ),
        ],
      ),
